...
const WeeklyWeather = ({ cityName, weeklyData, loading, error, fetchWeather }) => {
  console.log('WeeklyWeather props:', { cityName, weeklyData, loading, error });
    useEffect(() => {
...
const mapStateToProps = (state) => ({
  weeklyData: state.weather.weeklyData,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  fetchWeather: (cityName) => dispatch(fetchWeatherRequest(cityName)),
});
