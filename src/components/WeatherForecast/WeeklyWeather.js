...
// import { fetchWeeklyWeatherRequest } from '../../redux/Actions/weeklyWeatherActions';
...
// }) => {
//   useEffect(() => {
//     // Fetch weekly weather data when the component mounts
//     if (cityName) {
//       fetchWeeklyWeather(cityName);
//     }
//   }, [cityName, fetchWeeklyWeather]);
...
//       <Text>Weekly Weather Data:</Text>
//       {/* Render the weekly weather data here */}
//     </View>
//   );
// };

// const mapStateToProps = (state) => ({
//   cityName: state.weeklyWeather.cityName,
//   weeklyData: state.weeklyWeather.weeklyData,
//   loading: state.weeklyWeather.loading,
//   error: state.weeklyWeather.error,
// });

// const mapDispatchToProps = {
//   fetchWeeklyWeather: fetchWeeklyWeatherRequest,
// };
